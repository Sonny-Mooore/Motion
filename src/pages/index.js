...
export default function Home() {
  ...
  const [glassButtonMenuOpen, setGlassButtonMenuOpen] = useState(false);

  const handleGlassButtonOpen = () => {
    setGlassButtonMenuOpen(!glassButtonMenuOpen);
  };
            ...
            <section id="hero" className="hero">
              <div className="hero_row">
                <div className="hero_left">
                  ...
                  <div className={'glass_button_menu_container'}>
                    <div
                      onClick={handleGlassButtonOpen}
                      className={`glass_button hero_cta ${glassButtonMenuOpen ? 'glass_button_open' : ''}`}
                      onMouseMove={(e) => {
                    ...
                    >
                      {glassButtonMenuOpen
                        ?
                        <div className={'glass_button_menu_open'}>
                          <div onClick={handleConnectClick}>
                            <div className="glass_button_menu_title">
                              Открыть бота
                              <img src="/images/tg.svg" alt="" />
                            </div>
                          </div>

                          <div className="glass_button_menu_line" />

                          <div>
                            <div onClick={() => router.push('https://cabinet.motion-vpn.com/')}
                                 className="glass_button_menu_title">Личный кабинет
                              <img width={19} height={19} src="/images/logo-white.svg" alt="" />
                            </div>
                          </div>

                          <div className="glass_button_menu_text">(если телеграм не грузит)</div>
                        </div>
                        :
                        'Подключить'
                      }
                      {glassButtonMenuOpen ? '' : <img alt="" src="/images/Vector.svg" />}
                    </div>
                    {glassButtonMenuOpen ? '' :
                    ...
                    {/*<div*/}
                    {/*  className="glass_button_menu_open"*/}
                    {/*  onMouseMove={(e) => {*/}
                    {/*    const rect = e.currentTarget.getBoundingClientRect();*/}
                    {/*    e.currentTarget.style.setProperty('--x', `${e.clientX - rect.left}px`);*/}
                    {/*    e.currentTarget.style.setProperty('--y', `${e.clientY - rect.top}px`);*/}
                    ...
                    {/*>*/}
                    {/*  <div>*/}
                    {/*    <div className="glass_button_menu_title">Открыть бота</div>*/}
                    {/*  </div>*/}

                    {/*  <div className="glass_button_menu_line" />*/}

                    {/*  <div>*/}
                    {/*    <div className="glass_button_menu_title">Личный кабинет</div>*/}
                    {/*  </div>*/}
            ...
            <section id="devices" className="section devices_section">
              ...
              <div className="devices_stores">
                {[{
                  ...
                  <div key={s.label} className={s.maxWidth ? 'store_btn store_btn_max_width' : `store_btn`}>
                    <img
                      width={52}
                      height={52}
                      src={s.icon}
                ...
                <div className={`faq_item ${faqSecondOpen ? 'faq_item_open' : ''}`}>
                  ...
                  {faqSecondOpen && <div className="faq_answer">
                    ...
                    <div className={'faq_title margin_32'}>
                      Технически невозможно украсть данные. Даже если бы мы захотели продать или передать ваши данные,
                      это
                      ...
                      продажи личных данных или бесконечных рекламных кампаний, как это делают многие бесплатные и
                      дешевые
                      VPN-сервисы.
                    </div>
